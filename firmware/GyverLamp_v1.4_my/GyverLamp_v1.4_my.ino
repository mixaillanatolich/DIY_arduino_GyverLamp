...
byte IP_STA[] = {192, 168, 1, 252};  // статический IP локальный (менять только последнюю цифру)
...
#define BTN_PIN 4
#define WIFI_MODE_PIN_1 5
#define WIFI_MODE_PIN_2 12
...
void setup() {
  ...
  pinMode(WIFI_MODE_PIN_1, INPUT_PULLUP);
  pinMode(WIFI_MODE_PIN_2, INPUT_PULLUP);
  boolean modeState1 = digitalRead(WIFI_MODE_PIN_1);
  boolean modeState2 = digitalRead(WIFI_MODE_PIN_2);

  //Access point  modeState1 = false && modeState2 = true (ESP_MODE == 0)
  //STA modeState1 = true && modeState2 = false (ESP_MODE == 1)
  //reset (no jumper) modeState1 = true && modeState2 = true

  //WIFI
  if (modeState1 == true && modeState2 == true) {
    WiFiManager wifiManager;
    wifiManager.resetSettings();
    ESP.restart();
  } else if (modeState1 == false && modeState2 == true) {
    ...
    server.begin();
  } else if (modeState1 == true && modeState2 == false) {
    WiFiManager wifiManager;
...
//                IPAddress(255, 255, 255, 0));
  ...
  int currBrightness = modes[currentMode].brightness;
